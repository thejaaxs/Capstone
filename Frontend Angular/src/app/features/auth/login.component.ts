    ...
    <section class="auth-page">
      <div class="auth-card">
        ...
        <div class="role-grid" aria-label="Select role">
          ...
          <button type="button" class="role-btn" [class.active]="selectedRole === 'ROLE_ADMIN'" (click)="selectedRole = 'ROLE_ADMIN'">
            Admin
          </button>
        </div>
...
export class LoginComponent {
  emailId = '';
  password = '';
  selectedRole: 'ROLE_CUSTOMER' | 'ROLE_DEALER' | 'ROLE_ADMIN' | null = 'ROLE_CUSTOMER';
  loading = false;
  ...
  private normalizeRole(role: string | null): 'ROLE_CUSTOMER' | 'ROLE_DEALER' | 'ROLE_ADMIN' | null {
