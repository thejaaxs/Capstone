...
public class AuthController {
  ...
  public AuthResponse register(@Valid @RequestBody RegisterRequest req) {
    ...
    // Usually after register you may auto-login
  ...
  public InternalUserResponse me(Authentication authentication) {
    ...
    return InternalUserResponse.builder()
        ...
        .password("PROTECTED") // do not expose hash here
        .role(u.getRole().name())
        .active(u.isActive())
        .build();
  }

  // ✅ Feign/internal endpoint: other services call this to load user hash+role
